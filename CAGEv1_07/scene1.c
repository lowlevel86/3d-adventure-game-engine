...
xPlatform = course1_TRANS[3+3*9] - course1_GLOBAL[3];
yPlatform = course1_TRANS[4+3*9] - course1_GLOBAL[4];
zPlatform = course1_TRANS[5+3*9] - course1_GLOBAL[5];
xEdge = course1_TRANS[6+3*9];
yEdge = course1_TRANS[7+3*9];
