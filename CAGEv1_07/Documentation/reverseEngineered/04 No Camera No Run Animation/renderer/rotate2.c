...
//add rotation (xR2, yR2, zR2) angles to the angles the rotation data creates (xR, yR, zR)
void addRotAngsToAngs(float xR2, float yR2, float zR2, float *xR, float *yR, float *zR)
{
   ...
   rotate(&xHoriAdd, &yHoriAdd, &zHoriAdd, 0, -xR2, 0);
   rotate(&xHoriAdd, &yHoriAdd, &zHoriAdd, yR2, 0, 0);
   rotate(&xHoriAdd, &yHoriAdd, &zHoriAdd, 0, 0, -zR2);
   
   rotate(&xVertAdd, &yVertAdd, &zVertAdd, 0, -xR2, 0);
   rotate(&xVertAdd, &yVertAdd, &zVertAdd, yR2, 0, 0);
   rotate(&xVertAdd, &yVertAdd, &zVertAdd, 0, 0, -zR2);
   
   rotate(&xFtBkAdd, &yFtBkAdd, &zFtBkAdd, 0, -xR2, 0);
   rotate(&xFtBkAdd, &yFtBkAdd, &zFtBkAdd, yR2, 0, 0);
   rotate(&xFtBkAdd, &yFtBkAdd, &zFtBkAdd, 0, 0, -zR2);
   ...
   normOrientRtnRot(xHoriAdd, yHoriAdd, zHoriAdd,
                    ...
                    xFtBkAdd, yFtBkAdd, zFtBkAdd, &xR2, &yR2, &zR2);
   
   rotate(&xHori, &yHori, &zHori, 0, -yR2, 0);
   rotate(&xVert, &yVert, &zVert, 0, -yR2, 0);
   rotate(&xFtBk, &yFtBk, &zFtBk, 0, -yR2, 0);
   
   rotate(&xHori, &yHori, &zHori, -xR2, 0, 0);
   rotate(&xVert, &yVert, &zVert, -xR2, 0, 0);
   rotate(&xFtBk, &yFtBk, &zFtBk, -xR2, 0, 0);
   
   rotate(&xHori, &yHori, &zHori, 0, 0, -zR2);
   rotate(&xVert, &yVert, &zVert, 0, 0, -zR2);
   rotate(&xFtBk, &yFtBk, &zFtBk, 0, 0, -zR2);

   normOrientRtnRot(xHori, yHori, zHori,
                    xVert, yVert, zVert,
                    xFtBk, yFtBk, zFtBk, &xR2, &yR2, &zR2);
...
void addParallelRotAngsToAngs(float lr, float tb, float cc, float *xR, float *yR, float *zR)
{
   float xHoriAdd = 1.0, yHoriAdd = 0.0, zHoriAdd = 0.0;
   float xVertAdd = 0.0, yVertAdd = 1.0, zVertAdd = 0.0;
   float xFtBkAdd = 0.0, yFtBkAdd = 0.0, zFtBkAdd = 1.0;
